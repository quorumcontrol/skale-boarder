    ...
    private contractConfigs() {
        return {
            [this.config.chainId]: {
                ...
                safeProxyFactoryAddress: this.config.deploys.GnosisSafeProxyFactory.address,
                ...
                fallbackHandlerAddress: this.config.deploys.CompatibilityFallbackHandler.address,
